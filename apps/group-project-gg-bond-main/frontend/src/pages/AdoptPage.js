...
const ADOPTABLE_PETS = [
  {
    id: 'p1', name: '豆豆', breed: '柯基 (Corgi)', type: 'dog', age: '2岁',
    gender: '♂', personality: '活泼好动，喜欢户外运动，对小孩友好',
    health: 95, energy: 88, hunger: 30,
    intro: '豆豆是一只精力充沛的小柯基，尾巴摇得像小螺旋桨！它喜欢和主人一起跑步，最爱追松鼠。性格开朗，是家里的开心果。',
    tags: ['柯基', '幼犬', '活泼', '适合有孩家庭'],
    bgGradient: 'linear-gradient(135deg,#fef3c7,#fde68a)',
    accentColor: '#f59e0b',
    emoji: '🐕',
    features: ['会握手', '会坐下', '爱游泳'],
    adoptionFee: 280,
  },
  {
    id: 'p2', name: '雪球', breed: '萨摩耶 (Samoyed)', type: 'dog', age: '1岁',
    gender: '♀', personality: '温柔友善，毛发雪白，需要定期护理',
    health: 98, energy: 75, hunger: 45,
    intro: '雪球拥有一身令人羡慕的雪白毛发，笑起来像是天使！它非常亲人，喜欢依偎在主人身边。对所有人和小动物都很友善。',
    tags: ['萨摩耶', '成犬', '温柔', '颜值担当'],
    bgGradient: 'linear-gradient(135deg,#f0f9ff,#bae6fd)',
    accentColor: '#0ea5e9',
    emoji: '🐕',
    features: ['微笑天使', '不咬人', '爱撒娇'],
    adoptionFee: 350,
  },
  {
    id: 'p3', name: '咪咕', breed: '英短蓝猫 (British Shorthair)', type: 'cat', age: '3岁',
    gender: '♂', personality: '安静独立，喜欢安静的环境，适合上班族',
    health: 92, energy: 60, hunger: 55,
    intro: '咪咕是一只典型的英短蓝猫，圆圆的脸蛋，铜铃般的眼睛。它性格沉稳，不爱叫，是独居人士的理想伴侣。',
    tags: ['英短', '成猫', '安静', '适合上班族'],
    bgGradient: 'linear-gradient(135deg,#e9d5ff,#ddd6fe)',
    accentColor: '#8b5cf6',
    emoji: '🐱',
    features: ['安静乖巧', '不拆家', '爱干净'],
    adoptionFee: 200,
  },
  {
    id: 'p4', name: '小橘', breed: '橘猫 (Orange Tabby)', type: 'cat', age: '6个月',
    gender: '♀', personality: '贪吃易胖，性格亲人，特别爱撒娇',
    health: 90, energy: 85, hunger: 70,
    intro: '小橘是一只可爱的橘猫宝宝，拥有一身虎斑纹路。它食欲旺盛，活泼可爱，喜欢围着人转。传说中"十只橘猫九只胖"！',
    tags: ['橘猫', '幼猫', '贪吃', '易胖体质'],
    bgGradient: 'linear-gradient(135deg,#ffedd5,#fed7aa)',
    accentColor: '#fb923c',
    emoji: '🐱',
    features: ['超级粘人', '爱撒娇', '胃口好'],
    adoptionFee: 150,
  },
  {
    id: 'p5', name: '阿黄', breed: '中华田园犬', type: 'dog', age: '4岁',
    gender: '♂', personality: '忠诚护家，聪明伶俐，抵抗力强',
    health: 97, energy: 70, hunger: 40,
    intro: '阿黄是地道的中华田园犬，一身黄毛油亮。它对主人无比忠诚，看家护院一把好手。非常聪明，指令一学就会。',
    tags: ['田园犬', '成犬', '忠诚', '好养活'],
    bgGradient: 'linear-gradient(135deg,#fef9c3,#fef08a)',
    accentColor: '#ca8a04',
    emoji: '🐕',
    features: ['看家护院', '不挑食', '超忠诚'],
    adoptionFee: 100,
  },
  {
    id: 'p6', name: '棉花糖', breed: '布偶猫 (Ragdoll)', type: 'cat', age: '2岁',
    gender: '♀', personality: '性格温和，喜欢被人抱，忍痛能力强',
    health: 94, energy: 65, hunger: 50,
    intro: '棉花糖是一只漂亮的布偶猫，被抱起时会全身放松，像个毛绒玩具。它拥有迷人的蓝色眼睛和丝滑的长毛，性格超级好。',
    tags: ['布偶猫', '成猫', '温柔', '爱抱抱'],
    bgGradient: 'linear-gradient(135deg,#fce7f3,#fbcfe8)',
    accentColor: '#ec4899',
    emoji: '🐱',
    features: ['任人抱', '蓝眼睛', '丝滑毛发'],
    adoptionFee: 380,
  },
];
